...
public class RingtonePlayingService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent intent_main_activity = new Intent(this.getApplicationContext(), RingAlarmActivity.class);
        ...
        if (!this.isRunning && startId == 1) {
            ...
            Intent toRingScreen = new Intent(this.getApplicationContext(), RingAlarmActivity.class);
            startActivity(toRingScreen);
        }
